      ...
      <v-card class="w-30">
        ...
        <v-tabs-items v-model="coursesTab">
          <v-tab-item>
            ...
            <v-list class="pa-0">
              <template v-for="(course, index) in teacher.courses">
...
export default {
  ...
  methods: {
    ...
    splitCourses () {
      this.teacher.courses.forEach(element => {
    ...
    async saveEditInfo () {
      console.log('edit save', this.editTeacher)
    ...
    undoEdit () {
      this.editTeacher = JSON.parse(JSON.stringify(this.teacher))
      this.editInfo = false
      console.log('undo edit', this.editTeacher)
    }
  },
  created () {
